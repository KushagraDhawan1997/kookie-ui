...
describe('Inspector onExpand/onCollapse callbacks', () => {
  it('does not fire onCollapse on initial mount when collapsed', () => {
    ...
    renderWithProviders(
      <Shell.Root>
        ...
        <Shell.Inspector presentation={{ initial: 'fixed' }} defaultOpen={false} onExpand={onExpand} onCollapse={onCollapse}>
          inspector
        </Shell.Inspector>
      </Shell.Root>,
    );
  ...
  it('does not fire onExpand on initial mount when expanded', () => {
    ...
    renderWithProviders(
      <Shell.Root>
        <Shell.Content>content</Shell.Content>
        <Shell.Inspector presentation={{ initial: 'fixed' }} defaultOpen={true} onExpand={onExpand} onCollapse={onCollapse}>
          inspector
        </Shell.Inspector>
      </Shell.Root>,
    );
    ...
    function ControlledFixture() {
      ...
      return (
        <Shell.Root>
          ...
          <Shell.Content>content</Shell.Content>
          <Shell.Inspector presentation={{ initial: 'fixed' }} open={open} onExpand={onExpand} onCollapse={onCollapse}>
            inspector
          </Shell.Inspector>
        </Shell.Root>
      );
