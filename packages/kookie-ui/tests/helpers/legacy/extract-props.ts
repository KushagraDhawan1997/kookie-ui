// Frozen copy of the pre-optimisation implementation. Kept only so
// `extract-props.parity.test.ts` can assert the rewrite produces identical
// output; nothing in `src/` may import it.
 ...
 */
function legacyExtractProps<P extends { className?: string; style?: React.CSSProperties; [key: string]: any }, T extends Record<string, PropDef>[]>(
  props: P,
  ...propDefs: T
