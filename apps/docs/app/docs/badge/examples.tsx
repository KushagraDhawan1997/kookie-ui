...
import { CheckmarkCircle02Icon, Clock01Icon, Cancel01Icon, MoreHorizontalIcon } from '@hugeicons/core-free-icons';
      ...
      <Flex direction="column" gap="4">
        <SectionHeader.Root>
          <SectionHeader.Content>
            ...
            <SectionHeader.Description>Tooltips add context without cluttering the UI. Hover over badges to reveal additional information about each feature status.</SectionHeader.Description>
          </SectionHeader.Content>
        </SectionHeader.Root>
        <PreviewBlock
          background="none"
          ...
          <Card variant="classic" size="2" style={{ minWidth: 320, maxWidth: 400 }}>
            <Flex direction="column" gap="3">
              <Flex justify="between" align="center">
                ...
                <Badge color="violet" tooltip="Released within the last 7 days" tooltipSide="left">
                  New
                </Badge>
              </Flex>
              <Separator size="4" />
              <Flex justify="between" align="center">
                ...
                <Badge color="cyan" tooltip="This feature is in testing and may change" tooltipSide="left">
                  Beta
                </Badge>
              </Flex>
            </Flex>
      ...
      <Flex direction="column" gap="4">
        <SectionHeader.Root>
          <SectionHeader.Content>
            ...
            <SectionHeader.Description>Size 1 badges work well for compact notification items. The solid variant creates stronger visual indicators for unread items.</SectionHeader.Description>
          </SectionHeader.Content>
        </SectionHeader.Root>
        <PreviewBlock
          background="none"
