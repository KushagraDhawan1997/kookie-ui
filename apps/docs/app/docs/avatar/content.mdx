...
- Solid gray fallback fills with step 12 and uses `--gray-1` text

### Removed

- `highContrast` prop. Gray fills with step 12 on its own, and fallback text reads the strong ink.
