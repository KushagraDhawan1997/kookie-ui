...
Standard rounding. Controls at 1x, surfaces at 0.75x.
...
Pill-shaped controls inside near-square panels — the widest contrast the system offers, and the default. Controls at 2x plus pill, surfaces capped at 1x.
