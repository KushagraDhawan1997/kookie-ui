      ...
      <Flex direction="column" gap="4">
        <SectionHeader.Root>
          <SectionHeader.Content>
            ...
            <SectionHeader.Description>Ghost variant with crimson color for like/heart actions. Click to toggle the liked state.</SectionHeader.Description>
          </SectionHeader.Content>
        </SectionHeader.Root>
        <PreviewBlock
          background="none"
...
>
  <HugeiconsIcon icon={FavouriteIcon} strokeWidth={1.75} />
        ...
        >
          <ToggleIconButton variant="ghost" size="2" color="crimson" pressed={liked} onPressedChange={setLiked} aria-label={liked ? 'Unlike' : 'Like'} tooltip={liked ? 'Unlike' : 'Like'}>
            <HugeiconsIcon icon={FavouriteIcon} strokeWidth={1.75} />
          </ToggleIconButton>
        </PreviewBlock>
      </Flex>
      ...
      <Flex direction="column" gap="4">
        <SectionHeader.Root>
          <SectionHeader.Content>
            ...
            <SectionHeader.Description>Toggle icon buttons for card-level actions like favorite and pin. Ghost variant keeps focus on the content.</SectionHeader.Description>
          </SectionHeader.Content>
        </SectionHeader.Root>
        <PreviewBlock
          background="none"
      ...
      <Flex direction="column" gap="4">
        <SectionHeader.Root>
          <SectionHeader.Content>
            ...
            <SectionHeader.Description>Toggle icon buttons for text formatting controls. Multiple toggles can be active simultaneously.</SectionHeader.Description>
          </SectionHeader.Content>
        </SectionHeader.Root>
        <PreviewBlock
          background="none"
      ...
      <Skeleton width="60%" height="12px" />
        ...
        >
          <Card variant="classic" size="2" style={{ width: '100%', maxWidth: 320 }}>
            <Flex direction="column" gap="3" p="1">
              <Flex gap="1" align="center">
                <ToggleIconButton variant="ghost" size="2" pressed={bold} onPressedChange={setBold} aria-label={bold ? 'Remove bold' : 'Bold'}>
                  <HugeiconsIcon icon={TextBoldIcon} strokeWidth={1.75} />
                </ToggleIconButton>
                <ToggleIconButton variant="ghost" size="2" pressed={italic} onPressedChange={setItalic} aria-label={italic ? 'Remove italic' : 'Italic'}>
                  <HugeiconsIcon icon={TextItalicIcon} strokeWidth={1.75} />
                </ToggleIconButton>
                <ToggleIconButton variant="ghost" size="2" pressed={underline} onPressedChange={setUnderline} aria-label={underline ? 'Remove underline' : 'Underline'}>
                  <HugeiconsIcon icon={TextUnderlineIcon} strokeWidth={1.75} />
                </ToggleIconButton>
              </Flex>
              <Flex direction="column" gap="1">
