...
import { Link as KUILink, Flex, Grid, Heading, Text } from '@kushagradhawan/kookie-ui';
      ...
      <Grid columns={{ initial: '1', sm: '2' }} gapX="7" gapY="9">
        ...
        <Flex direction="column" gap="4">
          <Flex direction="column" gap="3">
            ...
            <Text as="p" size="3" color="gray">
              Every component in the package. Each page covers what the component is, which props it takes and how to
              use it.
            </Text>
          </Flex>
          <Flex align="start">
